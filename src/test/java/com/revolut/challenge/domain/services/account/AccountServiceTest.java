...
class AccountServiceTest {
    ...
    @Test
    public void creditAccount_credits_account_said_amount() throws InvalidAccountException {
    ...
    @Test
    public void debitAccount_debits_account_from_said_amount() throws InvalidAccountException, InsufficientFundsException {
        Amount amount = Amount.builder().amount(BigDecimal.TEN).build();
        accountService.creditAccount(ACCOUNT_ID, amount);
    ...
    @Test
    public void creditAccount_throws_InvalidAccountException_if_account_invalid() {
    ...
    @Test
    public void debitAccount_throws_InvalidAccountException_if_account_invalid() {
    ...
    @Test
    public void debitAccount_throws_InsufficientFunds_exception_if_account_cannot_be_debited() {
        Amount amount = Amount.builder().amount(BigDecimal.TEN).build();
        Assertions.assertThrows(InsufficientFundsException.class, () -> accountService.debitAccount(ACCOUNT_ID, amount));
    }

    @Test
    public void isAccountValid_returns_true_if_account_exists() {
        Assertions.assertTrue(accountService.isAccountValid(ACCOUNT_ID));
    }

    @Test
    public void isAccountValid_returns_false_it_account_not_existent() {
        Assertions.assertFalse(accountService.isAccountValid(AccountId.from(UUID.randomUUID())));
    }

    @Test
    public void createAccount_inserts_a_new_account() {
